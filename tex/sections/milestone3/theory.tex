...
\subsubsection{Metric perturbations}\label[sec]{mil3:theo:sec:metric_pert}
    ...
    It is the Poisson equation that determines the evolution of $\Phi$. The sum $\Phi + \Psi$ is given by an equation for anisotropic stress, resulting in a dynamical expression for $\Psi$. The equations are given in~\cref{app:pert:sec:full_system},~\cref{app:pert:eq:metric_perturbations}. The absence of anisotropic stress causes $\Psi=-\Phi$.
