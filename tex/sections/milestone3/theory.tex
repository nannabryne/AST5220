...
%     - \frac{ck}{\Hp}\Theta_{\ell+1}- \dv{\Phi}{x} & \ell =0\\
...
%     \frac{ck}{\Hp} \Theta_{\ell-1}- \frac{c(\ell+1)}{\Hp \eta}\Theta_{\ell} + \dv{\tau}{x}\Theta_\ell &  \ell = \ell\ped{max}
% \end{cases}
% \end{equation}
...
\begin{split}
    ...
    - \delta_{\ell,0}\dv{\Phi}{x}% + \delta_{\ell,1}\frac{ck}{3\Hp}\Psi 
\end{split}
\end{equation}
