...
From this point (Sects.~\ref{sec:mil3} \& \ref{sec:mil4}), the results were obtained \textit{after} reproducing the background with $N\ped{eff}=0$. This caused some changes in numerical values for e.g.~matter-radiation equality, but did not change the important results and takeaways from the previous work (Sects.~\ref{sec:mil1} \& \ref{sec:mil2}). 
...
\begin{table}[h]
    ...
    \caption{The comoving wavenumbers \dots }
