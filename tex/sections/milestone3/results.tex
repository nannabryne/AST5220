...
\begin{figure*}[!ht]
    ...
    \begin{subfigure}{0.49\linewidth}
        ...
        \caption{Velocity perturbations $u_s(x, k)$ for $s=\mathrm{c,b}$ and $\gamma$ meaning cold dark matter, baryons and photons, respectively. Recall that $\delta_\gamma(x, k)=-3\Theta_1(x, k)$.} 
...
\begin{figure}[!ht]
    ...
    \caption{The graphs show the quadrupole moment $\Theta_2(x, k)$ as function of logarithmic expansion factor $x$ for three different wavenumbers $k$.} 
...
\begin{figure}[!ht]
    ...
    \caption{The graphs show the metric perturbations as functions of logarithmic expansion factor $x$ for three different wavenumbers $k$. Upper panel: spatial curvature $\Phi(x, k)$. Lower panel: sum of the spatial curvature $\Phi(x, k)$ and the gravitational potential $\Psi(x, k)$.} 
