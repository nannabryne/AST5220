...
\subsubsection{Perturbations}\label[sec]{mil3:imp:sec:main_work}
    The following recipe \ref{item_one} -- \ref{item_six} was used for each of the 100 logarithmically spaced values $k \in [5\cross10^{-5}, \,3\cross 10^{-1}]\unit{Mpc}^{-1}$. We used an array of $1\cross 10^4+1$ values of $x\in [x\ped{init}, 0]$ with $x\ped{init}=-20$.
