...
\begin{figure}[!ht]
    ...
    \caption{The free electron fraction $X_e(x)$ resulting from the Saha and Peebles equations. The dash-dotted line represents the solution from the Saha equation only.} 
...
\begin{figure}[!ht]
    ...
    \caption{The optical depth $\tau(x)$ and its derivatives $-\dv{\tau(x)}{x}$ and $\dv[2]{\tau(x)}{x}$ as functions of logarithmic scale factor $x$.} 
    \label[fig]{mil2:res:fig:optical_depth}
\end{figure}
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{milestone2/visibility_function_misc.png} 
    \caption{The visibility function $\gti(x)$ and the shape of its derivatives $\dv{\gti(x)}{x}$ and $\dv[2]{\gti(x)}{x}$ as functions of logarithmic scale factor $x$.} 
