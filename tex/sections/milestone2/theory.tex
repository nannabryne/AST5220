...
\subsubsection{Hydrogen recombination}\label[sec]{mil2:theo:sec:recombination}
    ...
    \begin{subequations}\label{mil2:theo:eq:Peebles_add}
        ...
        \end{align}
    \end{subequations}
    A detailed description of~\cref{mil2:theo:eq:Peebles_add} is found in~\citet{Peebles1968}. \colorbox{orange}{Necessary to describe components here??}~\citep{DodelsonBook,ChungPei1995,Peebles1968}
