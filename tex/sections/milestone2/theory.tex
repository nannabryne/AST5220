...
\subsubsection{Sound horizon}\label[sec]{mil2:theo:sec:sound_horizon}
    ...
    \end{equation}
    Evaluating $r_s\equiv s(x\!=\!x\ped{*})$ gives the sound horizon at decoupling. At this point, the plasma through which sound waves propagate is no longer present and the waves are frozen in.
