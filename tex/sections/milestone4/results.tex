...
As functions of wavenumber $k$, we plot the transfer function for a set of angular wavenumbers $\ell \in \{\, 6,\, 100,\, 200,\, 500,\, 1000 \,\}$ in~\cref{mil4:res:fig:transfer}. For a smaller range of values of $k$, we also plot the interesting part of the integrand in the expression for the CMB power spectrum. 
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{milestone4/Theta_ell.pdf} 
...
We found the fundamental tone at $\ell_1 = 205$. The next two peaks were located at $\ell_2=490$ and $\ell_3 = 727$. Higher peaks were found at $\ell_4=1008$, $\ell_5=1273$, $\ell_6=1552$ and $\ell_7=1825$.
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{milestone4/matter_power_spectrum.pdf} 
