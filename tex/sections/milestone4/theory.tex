...
\subsubsection{Effective temperature perturbation}\label[sec]{mil4:theo:sec:eff_temp_pert}
    We intend to give a high-level analysis of the CMB power spectrum to be able to extract physics from it. For more details, see~\citet{WintherIsComing} and~\citet{DodelsonBook}.
