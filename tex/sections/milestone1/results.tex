...
\begin{figure}
    ...
    \begin{subfigure}{\linewidth}
        ...
        \caption{The single and double derivative of the conformal Hubble factor, scaled with the factor itself, $\frac{1}{\Hp(x)}\dv{\Hp(x)}{x}$ and $\frac{1}{\Hp(x)}\dv[2]{\Hp(x)}{x}$.} 
