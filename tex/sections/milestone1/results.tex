...
\subsubsection{Supernova fitting}
    Before adjusting any parameters, we compared our initial model with the supernova data from \citep{supernovadata}. This by-eye comparison is found in \cref{mil1:res:fig:lum_dist_vs_z}. We demonstrated the model favoured by the data in the same plot.
