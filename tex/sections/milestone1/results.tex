...
\begin{figure}
    \begin{subfigure}{\linewidth}
        ...
        \caption{The conformal Hubble factor $\Hp(x)$.}
        \label[fig]{mil1:res:fig:hubble_of_x}
    \end{subfigure}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{milestone1/Hubble_derivatives.png} 
        \caption{The single and double derivative of the conformal Hubble factor, scaled with the factor itself, $\frac{1}{\Hp(x)}\frac{\D \Hp(x)}{\D x}$ and $\frac{1}{\Hp(x)}\frac{\D^2 \Hp(x)}{\D x^2}$.} 
        \label[fig]{mil1:res:fig:der_hubble}
    \end{subfigure}
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{milestone1/eta_Hubble.png} 
        \caption{The product of the conformal time and Hubble factor, divided by the speed of light, $\Hp(x)\frac{\eta(x)}{c}$. The solid graph blows up at late times.} 
...
\begin{figure}[!ht]
    ...
    \caption{Cosmic time $t(x)$ and conformal time per speed of light $\frac{\eta(x)}{c}$.} 
...
\begin{table}[h]
    ...
    \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}} l *{3}{d{2.4}} l}
        \toprule
        % & \multicolumn{3}{c}{Time of event} \\
        & \multicolumn{1}{c}{$x$} & \multicolumn{1}{c}{$z$} & \multicolumn{1}{c}{$t$} & \\
        \midrule
        Rad.-matter equality       & -8.132 & 3401 & 51.06\text{~ka}& \\
        Accel. begins         & -0.4867 & 0.6270 & 7.753\text{~Ga}& \\
        Matter-DE equality      & -0.2560 & 0.2918 & 10.37\text{~Ga}& \\
        Today                & -0.000 & 0.000 & 13.86 \text{~Ga}& \\
        \midrule
...
\subsubsection{Supernova fitting}
    Before adjusting any parameters, we compared our initial model with the supernova data from \citep{supernovadata}. This by-eye comparison is found in \cref{mil1:res:fig:lum_dist_vs_z}.
    
    \begin{figure}[!ht]
        \centering
        \includegraphics[width=\linewidth]{milestone1/lum_distance_vs_redshift.png} 
        \caption{The observed and computed luminosity distance per redshift $\frac{d_L^\mathrm{obs}(z) \pm \sigma_\mathrm{err}(z)}{z}$ and $\frac{d_L(z)}{z}$.} 
